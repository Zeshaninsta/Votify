  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center">
      <div className="w-full flex flex-col justify-center items-center ">
        {userData && (
          <div
            className="flex items-center justify-center w-[95%] flex-col mt-10 p-5"
            style={{
      ...
      <div className="flex-grow h-full m-auto w-[95%] mt-10 ">
        {userData && (
          <div className="grid grid-cols-2 gap-x-4 gap-y-2">
            ...
            <div className="border p-4">
              <p className="font-semibold text-gray-600">Selected Candidate:</p>
              <p>{userData.selectedCandidate}</p>
            </div>
            <div className="border p-4">
              <p className="font-semibold text-gray-600">Voted:</p>
              <p>{userData.voted}</p>
            </div>
          </div>
        )}
